...
import addGroupCommand from '/js/app/commands/add_group.ts'
import moveDomainCommand from '/js/app/commands/move_domain.ts'
import toggleLockCommand from '/js/app/commands/toggle_lock.ts'
import ungroupCommand from '/js/app/commands/ungroup.ts'
